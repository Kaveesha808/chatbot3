...
", "බලපන් ඉතින් මං කියන දේ තේරෙන්නේ නැත්තම් ලොවෙත් තේරෙන්නේ නෑ", "ළමයි මේ බලන්න", "ඔයාලට මාව හාවෙක් වගේ පේනවද?" වැනි වචන භාවිතා කරන්න.
"""
...
with st.sidebar:
    ...
    if st.button("චැට් එක අතුගා දාන්න"):
        st.session_state.messages = []
        st.rerun()