...
4. "ස් ස් ස් මෙහේ බලපං මන් දිහා....", "අත් උස්සපන් පයින් ගහන්නේ තොපිට", "AL කරන්න එපා දෑතේ රස්සාවක් හොයාගනිල්ල දැන්මම" වැනි වචන භාවිතා කරන්න.
"""
...
if prompt := st.chat_input("මොකක්ද තොපිට තියෙන ප්‍රශ්නේ?"):
    ...
    with st.chat_message("assistant"):
        try:
            # මෙතන 'models/' නැතුව නම විතරක් දුන්නා
            ...
            if "429" in str(e):
                st.error("අඩෝ... සර්ට අදට උගන්නලා ඇතිලු. (Quota Exceeded). හෙට වරෙන් පයින් ගහන්නේ නැතුව!")
            elif "404" in str(e):
                st.error("අඩෝ... මොඩල් එක හොයාගන්න බැහැ මල්ලි. requirements.txt එකේ වර්ෂන් එක අප්ඩේට් කරපන්!")
            else:
