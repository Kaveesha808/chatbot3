...
if prompt := st.chat_input("මොකක්ද තොපිට තියෙන ප්‍රශ්නේ?"):
    ...
    with st.chat_message("assistant"):
        ...
        # --- පට්ට කවුන්ට් ඩවුන් එක මෙතන ---
        for i in range(3, 0, -1):
            # බබල් එක ඇතුළේ සර් බනින ගමන් ටයිම් එක පෙන්වනවා
            message_placeholder.markdown(f"ස් ස් ස්... තව තත්පර {i}ක් ඉඳපං මෝඩයා! ⏳")
            time.sleep(1)
        
        message_placeholder.markdown("හරි... දැන් අහපන් බලන්න. 🎤")
        full_response = ""
        
        try:
            # දැන් තමයි Gemini 3 Flash එකට මැසේජ් එක යවන්නේ
            ...
            if "429" in str(e):
                st.error("පොඩ්ඩක් ඉඳපං! තොපි මැසේජ් ගහන වේගයට සර්වර් එකටත් පයින් ගහන්න හිතෙනවා ඇති.")
            else:
